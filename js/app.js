...
const PRODUCTS = [
  ...
  { id:5,  name:'Скалярия ангел',             cat:'Рыбки',         price:320,  old:400,  img:'https://avatars.mds.yandex.net/i?id=8d69988f56b3a5f4ba78bd675b722166_l-5134183-images-thumbs&n=13',    desc:'Элегантная цихлида треугольной формы. Миролюбива к рыбам схожего размера, живёт до 10 лет.', rating:4.8, cnt:156, badge:null },
  ...
  { id:17, name:'Hikari Cichlid Gold Mini',     cat:'Корма',         price:620,  old:700,  img:'https://s3.br39.online/a/s750/11edfe/59537d8b4163a8dcc7527d937a4f/Hikari-Cichlid-Gold-Mini-250g-pokarm-dla-pielegnic', desc:'Специальный корм для цихлид в мини-гранулах. Усиливает жёлтый и оранжевый окрас.', rating:4.6, cnt:129, badge:null },
  /* Декор */
