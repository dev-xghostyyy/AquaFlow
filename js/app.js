...
const PRODUCTS = [
  ...
  { id:5,  name:'Скалярия ангел',             cat:'Рыбки',         price:320,  old:400,  img:'https://static.tildacdn.com/tild3036-3630-4165-b134-663436373935/1586702444_2020-04-1.jpeg',    desc:'Элегантная цихлида треугольной формы. Миролюбива к рыбам схожего размера, живёт до 10 лет.', rating:4.8, cnt:156, badge:null },
  ...
  /* Фильтры */
  { id:10, name:'Eheim Classic 150',           cat:'Фильтры',       price:3200, old:3800, img:'https://waterworlds.ru/image/cache/catalog/Filtr/EHEIM/Classic2211/eheim-2211-classic-kulso-szuro-1-1000x700.jpg',  desc:'Легендарный немецкий внешний фильтр. Бесшумный, производительность 220 л/ч. Для аквариумов до 150 л.', rating:4.9, cnt:312, badge:'Хит' },
  ...
  { id:17, name:'Hikari Cichlid Gold Mini',     cat:'Корма',         price:620,  old:700,  img:'https://a.allegroimg.com/original/1155c4/77e39a604b5dba046c618704431b/Hikari-Cichlid-Gold-MINI-Pokarm-Tanganika-57g', desc:'Специальный корм для цихлид в мини-гранулах. Усиливает жёлтый и оранжевый окрас.', rating:4.6, cnt:129, badge:null },
  /* Декор */
  ...
  { id:19, name:'Грунт кварцевый белый 5 кг',  cat:'Декор',         price:580,  old:650,  img:'https://ir.ozone.ru/s3/multimedia-1-j/7172996491.jpg', desc:'Натуральный кварц фракции 2–3 мм. Не меняет химию воды. 5 кг хватает на 50 л аквариума.', rating:4.5, cnt:389, badge:null },
  ...
  /* Оборудование */
  { id:23, name:'Aquael Ultra Heater 150W',    cat:'Оборудование',  price:1200, old:1400, img:'https://basket-25.wbbasket.ru/vol4405/part440587/440587126/images/big/1.webp', desc:'Точный нагреватель с термостатом и погрешностью ±0.5°C. Двойная защита от перегрева.', rating:4.8, cnt:234, badge:null },
